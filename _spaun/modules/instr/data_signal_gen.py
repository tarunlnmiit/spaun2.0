...
def Data_Signal_Generator_Network(vocab, net_label, **args):
    ...
    dsgn_args = dict(args)
    n_neurons_dsgn = dsgn_args.get('n_neurons', cfg.n_neurons_ens)
    ...
    with net:
        ...
        ea = cfg.make_ens_array(n_neurons=n_neurons_dsgn)
        ...
        zero_detect = nengo.Ensemble(n_neurons_dsgn, 1,
                                     encoders=Choice([[1]]),
        ...
        gate_sig_gen = DetectChange(
            ...
            item_magnitude=cfg.get_optimal_sp_radius(vocab.dimensions), n_neurons=n_neurons_dsgn)
